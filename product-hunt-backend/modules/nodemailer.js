...
function sendVerificationMail (user) {
    ...
    var transporter = nodeMailer.createTransport({
        ...
        auth: {
            ...
            clientId: process.env.GOOGLE_EMAIL_CLIENT_ID, //replace with your password
    ...
    var mailOptions = {
        ...
        <![endif]-->
              <div style='background:#feae39;background-color:#feae39;margin:0px auto;max-width:600px;'>
                <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#feae39;background-color:#feae39;width:100%;'>
                  <tbody>
                    <tr>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style='width:120px;'>
                                        <img alt='Avatar' height='120' src='https://assets.opensourceemails.com/imgs/mantra/activation.jpg' style='border:0;display:block;font-size:13px;height:120px;outline:none;text-decoration:none;width:100%;' width='120' />
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                            ...
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;' vertical-align='middle'>
                                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:separate;line-height:100%;width:200px;'>
                                  <tr>
                                    <td align='center' bgcolor='#ffffff' role='presentation' style='background-color:#ffffff;border:none;border-radius:0px;cursor:auto;height:25px;padding:10px 25px;' valign='middle'>
                                      <a href="http://localhost:3000/user/verification/${user.id}" style='background:#ffffff;color:#feae39;font-family:Open Sans, Arial, sans-serif;font-size:17px;font-weight:bold;line-height:20px;margin:0;text-decoration:none;text-transform:uppercase;' target='_blank'>
                                        Verify
                                      </a>
                                    </td>
                                  </tr>
